...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('App\Contracts\Services\Student\StudentApiServiceInterface','App\Services\Student\StudentApiServices');
        $this->app->bind('App\Contracts\Dao\Student\StudentApiDaoInterface','App\Dao\Student\StudentApiDao');
    }
