...
if (isset($_POST['update'])) {
    ...
    if ((!empty($_POST['email']) && !filter_var($_POST['email'], FILTER_VALIDATE_EMAIL))) {
    ...
    } elseif(((!empty($_POST['name']) &&!empty($_POST['email']) && filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)))) {
        ...
        echo "<div class='alert alert-success' role='alert'>User Account Updated Successfully!!!<a href='index.php' class='btn btn-outline-success'>OK</a></div>";
    }
}
?>
<section>
